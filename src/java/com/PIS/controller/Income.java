...
//    out.println("<p class='name'>"+name+"</p> ");
        ...
        out.println("<form action='IncomeController'>");
        
            
            int id = ub.getUserid();
            IncomeCategoryDAO icb = new IncomeCategoryDAO();
            ArrayList<IncomeCategouryBean> y = icb.findAll(id);
        
        out.println("<center><table style=\"font-size: 2vw;\">");
            out.println("<tr>");
            out.println("<td>Income</td><td> : </td>");
            ...
            out.println("</tr>");
            out.println("<tr>");
            out.println(" <td>Receive By</td><td> : </td>");
