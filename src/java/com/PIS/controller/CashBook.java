...
//    out.println("<p class='name'>"+name+"</p> ");
        ...
        out.println("<legend style=\"font-size: 3vw; font-weight:600\">Cash <span id='span'>Book </span></legend>");
        
        out.println("<center><form action='BankBook'>");
            out.println("<table><tr><td> <br>CashBook</td><td>DateFrom<br><input type='date' name='start'></td><td>To<br><input type='date' name='end'></td><td><br><input type='submit' value='Show'></td>");
            out.println("</form>");  
//            out.println("<center><table style='padding:10px;'>");
            out.println("<tr style='background-color:black; color:white;'><th>S.No.</th><th>Date</th><th>Amount</th><th>Pay/Receive</th></tr>");
