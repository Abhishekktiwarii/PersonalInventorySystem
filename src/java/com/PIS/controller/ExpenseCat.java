...
public class ExpenseCat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExpenseCat</title>");            
            out.println("</head>");
            out.println("<body>");
...
//    out.println("<p class='name'>"+name+"</p> ");
        ...
        out.println("<form action='AddExpCat'>");
        ...
        for(ExpenseCategoryBean a:al){
            out.println("<tr class='table'><td class='table'>"+a.getExp_catname()+"</td><td class='table'>"+a.getExp_catdetails()+"</td><td class='table'><a href='UpdateExpenseCategory?id="+a.getExpcatid()+"'>Edit<a/></td><td class='table'><a href='DeleteExpense?id="+a.getExpcatid()+"'>Delete</a></td></tr>");
