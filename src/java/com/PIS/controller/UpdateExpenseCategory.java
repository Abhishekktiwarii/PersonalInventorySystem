...
//    out.println("<p class='name'>"+name+"</p> ");
        ...
        out.println("<form action='UpdateExpCat'>");
        int id = Integer.parseInt(request.getParameter("id"));
        ExpenseCategoryDAO ed = new ExpenseCategoryDAO();
        ExpenseCategoryBean eb = new ExpenseCategoryBean();
        
        ExpenseCategoryBean al = ed.findById(id);
      
        
        out.println("<center><table style=\"font-size: 2vw;\">");
        out.println("<tr ><td>Category id</td><td> : </td><td><input type='text' disabled name='expid' value='"+al.getExpcatid()+"' ></td></tr>");
        out.println("<tr><td>Category name</td><td> : </td><td><input type='text' value='"+al.getExp_catname()+"'  name='cn' ></td></tr>");
        out.println("<tr><td>Category detail </td><td> : </td><td><input type='text' value='"+al.getExp_catdetails()+"'  name='cd'></td></tr>");
