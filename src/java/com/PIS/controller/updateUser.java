...
//    out.println("<p class='name'>"+name+"</p> ");
        out.println("<div class='b21'>");
            out.println("<ul>");
                out.println("<li> <a  class='sidemenu' href=''> Expense Category</a></li>");
                out.println("<li> <a  class='sidemenu' href=''> Income Category</a> </li>");
                out.println("<li> <a  class='sidemenu' href=''> Expenses</a></li>");
                out.println("<li> <a  class='sidemenu' href=''> Income</a></li>");
                out.println("<li> <a  class='sidemenu' href=''> Cash book</a></li>");
                out.println("<li> <a  class='sidemenu' href=''> Bank Book</a></li>");
                out.println("<li> <a  class='sidemenu' href=''> Day Book</a></li>");
                out.println("<li> <a  class='sidemenu' href=''> Balance Sheet</a></li>");
            out.println("</ul>");
        out.println("</div>");
        out.println("<div class='b22'>");
        out.println("<fieldset  style='width: 50%; margin: auto; padding:2vw'>");
        out.println("<legend style=\"font-size: 3vw; font-weight:600\">User <span id='span'>Profile</span></legend>");
        out.println("<form action='UpdateUserProfile'>");
                    
            out.println("<center><table style=\"font-size: 2vw;\">");
            out.println("<tr><td>Userid </td><td> : </td><td><input type='text' name='id' value="+ub.getUserid()+" required></td></tr>");
            out.println("<tr><td>Name </td><td> : </td><td><input type='text' name='name' value="+ub.getName()+" required></td></tr>");
            out.println("<tr><td>UserName </td><td> : </td><td><input type='text' name='un' value="+ub.getUsername()+" required></td></tr>");
            out.println("<tr><td>Password </td><td> : </td><td><input type='password' name='pwd' value="+(String)ub.getPassword()+"></td></tr>");
            out.println("<tr><td>PhoneNo </td><td> : </td><td><input type='text' name='mob' value="+ub.getMobile()+" required></td></tr>");
            out.println("<tr><td>Email Id </td><td> : </td><td><input type='email' name='email' value="+ub.getEmail()+" required></td></tr>");
            out.println("<tr><td>Address </td><td> : </td><td><input type='text' name='add' value="+ub.getAddress()+" required></td></tr>");
            out.println("<tr><td> </td><td></td><td><input type=\"submit\" value=\"Update\"></td></tr>");
