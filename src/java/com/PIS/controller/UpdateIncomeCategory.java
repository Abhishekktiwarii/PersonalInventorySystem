...
//    out.println("<p class='name'>"+name+"</p> ");
        ...
        out.println("<form action='UpdateIncCat'>");
        int id = Integer.parseInt(request.getParameter("id"));
        IncomeCategoryDAO ed = new IncomeCategoryDAO();
        IncomeCategouryBean eb = new IncomeCategouryBean();
        
        IncomeCategouryBean al = ed.findById(id);
        
//        out.println(al.getInc_catid());
//        out.println(al.getInc_catname());
      
        
        out.println("<center><table style=\"font-size: 2vw;\">");
        out.println("<tr ><td>Category id</td><td> : </td><td><input type='text' disabled name='expid' value='"+al.getInc_catid()+"' ></td></tr>");
        out.println("<tr><td>Category name</td><td> : </td><td><input type='text' value='"+al.getInc_catname()+"'  name='cn' ></td></tr>");
        out.println("<tr><td>Category detail </td><td> : </td><td><input type='text' value='"+al.getInc_catdetails()+"'  name='cd'></td></tr>");
        out.println("<tr><td> </td><td></td><td><input type=\"submit\" value=\"Update\"><input type=\"reset\" value=\"Reset\"></td></tr>");
