...
//            rd.include(request, response);
        ...
        out.println(".b22 {width: 70vw;height: 85%;float: right;margin-top: 2vw;margin-right: 3vw;}");
...
//    out.println("<p class='name'>"+name+"</p> ");
        ...
        out.println("<fieldset  style='width: 50%; margin: auto; padding:3vw'>");
            ...
            out.println("<tr><td>Name </td><td> : </td><td>"+ub.getName()+"</td></tr>");
            out.println("<tr><td>UserName </td><td> : </td><td>"+ub.getUsername()+"</td></tr>");
            out.println("<tr><td>Password </td><td> : </td><td>"+ub.getPassword()+"</td></tr>");
            out.println("<tr><td>PhoneNo </td><td> : </td><td>"+ub.getMobile()+"</td></tr>");
            out.println("<tr><td>Email Id </td><td> : </td><td>"+ub.getEmail()+"</td></tr>");
            out.println("<tr><td>Address </td><td> : </td><td>"+ub.getAddress()+"</td></tr>");
